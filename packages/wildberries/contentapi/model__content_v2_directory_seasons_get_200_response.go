...
// checks if the ContentV2DirectorySeasonsGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContentV2DirectorySeasonsGet200Response{}
...
func NewContentV2DirectorySeasonsGet200Response() *ContentV2DirectorySeasonsGet200Response {
	this := ContentV2DirectorySeasonsGet200Response{}
	return &this
}
...
type NullableContentV2DirectorySeasonsGet200Response struct {
	value *ContentV2DirectorySeasonsGet200Response
	isSet bool
}

func (v NullableContentV2DirectorySeasonsGet200Response) Get() *ContentV2DirectorySeasonsGet200Response {
	return v.value
}

func (v *NullableContentV2DirectorySeasonsGet200Response) Set(val *ContentV2DirectorySeasonsGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableContentV2DirectorySeasonsGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableContentV2DirectorySeasonsGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContentV2DirectorySeasonsGet200Response(val *ContentV2DirectorySeasonsGet200Response) *NullableContentV2DirectorySeasonsGet200Response {
	return &NullableContentV2DirectorySeasonsGet200Response{value: val, isSet: true}
}

func (v NullableContentV2DirectorySeasonsGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContentV2DirectorySeasonsGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
