...
// checks if the ResponseBodyContentError403 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseBodyContentError403{}
...
func NewResponseBodyContentError403() *ResponseBodyContentError403 {
	this := ResponseBodyContentError403{}
	return &this
}
...
type NullableResponseBodyContentError403 struct {
	value *ResponseBodyContentError403
	isSet bool
}

func (v NullableResponseBodyContentError403) Get() *ResponseBodyContentError403 {
	return v.value
}

func (v *NullableResponseBodyContentError403) Set(val *ResponseBodyContentError403) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseBodyContentError403) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseBodyContentError403) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseBodyContentError403(val *ResponseBodyContentError403) *NullableResponseBodyContentError403 {
	return &NullableResponseBodyContentError403{value: val, isSet: true}
}
