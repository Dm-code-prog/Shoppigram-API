...
// checks if the ContentV2BarcodesPost200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContentV2BarcodesPost200Response{}
...
func NewContentV2BarcodesPost200Response() *ContentV2BarcodesPost200Response {
	this := ContentV2BarcodesPost200Response{}
	return &this
}
...
type NullableContentV2BarcodesPost200Response struct {
	value *ContentV2BarcodesPost200Response
	isSet bool
}

func (v NullableContentV2BarcodesPost200Response) Get() *ContentV2BarcodesPost200Response {
	return v.value
}

func (v *NullableContentV2BarcodesPost200Response) Set(val *ContentV2BarcodesPost200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableContentV2BarcodesPost200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableContentV2BarcodesPost200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContentV2BarcodesPost200Response(val *ContentV2BarcodesPost200Response) *NullableContentV2BarcodesPost200Response {
	return &NullableContentV2BarcodesPost200Response{value: val, isSet: true}
}

func (v NullableContentV2BarcodesPost200Response) MarshalJSON() ([]byte, error) {
