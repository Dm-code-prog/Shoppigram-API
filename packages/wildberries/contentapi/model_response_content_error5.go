...
// checks if the ResponseContentError5 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseContentError5{}

// ResponseContentError5 struct for ResponseContentError5
type ResponseContentError5 struct {
	Data map[string]interface{} `json:"data,omitempty"`
	// Флаг ошибки
	Error *bool `json:"error,omitempty"`
	// Описание ошибки
	ErrorText        *string                                `json:"errorText,omitempty"`
	AdditionalErrors *ResponseContentError5AdditionalErrors `json:"additionalErrors,omitempty"`
}
...
func (o *ResponseContentError5) GetAdditionalErrors() ResponseContentError5AdditionalErrors {
	if o == nil || IsNil(o.AdditionalErrors) {
		var ret ResponseContentError5AdditionalErrors
		return ret
	}
...
// SetAdditionalErrors gets a reference to the given ResponseContentError5AdditionalErrors and assigns it to the AdditionalErrors field.
func (o *ResponseContentError5) SetAdditionalErrors(v ResponseContentError5AdditionalErrors) {
	o.AdditionalErrors = &v
}

func (o ResponseContentError5) MarshalJSON() ([]byte, error) {
...
func (o ResponseContentError5) ToMap() (map[string]interface{}, error) {
...
type NullableResponseContentError5 struct {
	value *ResponseContentError5
	isSet bool
}

func (v NullableResponseContentError5) Get() *ResponseContentError5 {
	return v.value
}

func (v *NullableResponseContentError5) Set(val *ResponseContentError5) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseContentError5) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseContentError5) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseContentError5(val *ResponseContentError5) *NullableResponseContentError5 {
	return &NullableResponseContentError5{value: val, isSet: true}
}

func (v NullableResponseContentError5) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseContentError5) UnmarshalJSON(src []byte) error {
	v.isSet = true
