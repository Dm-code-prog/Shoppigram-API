...
// checks if the ResponseContentError1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseContentError1{}

// ResponseContentError1 struct for ResponseContentError1
type ResponseContentError1 struct {
	...
	AdditionalErrors *ResponseContentError1AdditionalErrors `json:"additionalErrors,omitempty"`
}
...
func (o *ResponseContentError1) GetAdditionalErrors() ResponseContentError1AdditionalErrors {
	if o == nil || IsNil(o.AdditionalErrors) {
		var ret ResponseContentError1AdditionalErrors
		return ret
	}
...
// SetAdditionalErrors gets a reference to the given ResponseContentError1AdditionalErrors and assigns it to the AdditionalErrors field.
func (o *ResponseContentError1) SetAdditionalErrors(v ResponseContentError1AdditionalErrors) {
	o.AdditionalErrors = &v
}

func (o ResponseContentError1) MarshalJSON() ([]byte, error) {
...
func (o ResponseContentError1) ToMap() (map[string]interface{}, error) {
...
type NullableResponseContentError1 struct {
	value *ResponseContentError1
	isSet bool
}

func (v NullableResponseContentError1) Get() *ResponseContentError1 {
	return v.value
}

func (v *NullableResponseContentError1) Set(val *ResponseContentError1) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseContentError1) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseContentError1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseContentError1(val *ResponseContentError1) *NullableResponseContentError1 {
	return &NullableResponseContentError1{value: val, isSet: true}
}

func (v NullableResponseContentError1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseContentError1) UnmarshalJSON(src []byte) error {
	v.isSet = true
