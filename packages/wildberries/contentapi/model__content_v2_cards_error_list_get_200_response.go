...
// checks if the ContentV2CardsErrorListGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContentV2CardsErrorListGet200Response{}

// ContentV2CardsErrorListGet200Response struct for ContentV2CardsErrorListGet200Response
type ContentV2CardsErrorListGet200Response struct {
	Data []ContentV2CardsErrorListGet200ResponseDataInner `json:"data,omitempty"`
	// Флаг ошибки.
...
func NewContentV2CardsErrorListGet200Response() *ContentV2CardsErrorListGet200Response {
	this := ContentV2CardsErrorListGet200Response{}
	return &this
}
...
func (o *ContentV2CardsErrorListGet200Response) GetData() []ContentV2CardsErrorListGet200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []ContentV2CardsErrorListGet200ResponseDataInner
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []ContentV2CardsErrorListGet200ResponseDataInner and assigns it to the Data field.
...
func (o ContentV2CardsErrorListGet200Response) MarshalJSON() ([]byte, error) {
...
func (o ContentV2CardsErrorListGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableContentV2CardsErrorListGet200Response struct {
	value *ContentV2CardsErrorListGet200Response
	isSet bool
}

func (v NullableContentV2CardsErrorListGet200Response) Get() *ContentV2CardsErrorListGet200Response {
	return v.value
}

func (v *NullableContentV2CardsErrorListGet200Response) Set(val *ContentV2CardsErrorListGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableContentV2CardsErrorListGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableContentV2CardsErrorListGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContentV2CardsErrorListGet200Response(val *ContentV2CardsErrorListGet200Response) *NullableContentV2CardsErrorListGet200Response {
	return &NullableContentV2CardsErrorListGet200Response{value: val, isSet: true}
}

func (v NullableContentV2CardsErrorListGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContentV2CardsErrorListGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
