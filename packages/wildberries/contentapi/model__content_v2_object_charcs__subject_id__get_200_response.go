...
// checks if the ContentV2ObjectCharcsSubjectIdGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContentV2ObjectCharcsSubjectIdGet200Response{}
...
func NewContentV2ObjectCharcsSubjectIdGet200Response() *ContentV2ObjectCharcsSubjectIdGet200Response {
	this := ContentV2ObjectCharcsSubjectIdGet200Response{}
	return &this
}
...
func (o *ContentV2ObjectCharcsSubjectIdGet200Response) GetData() []ContentV2ObjectCharcsSubjectIdGet200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []ContentV2ObjectCharcsSubjectIdGet200ResponseDataInner
		return ret
	}
	return o.Data
}
...
func (o ContentV2ObjectCharcsSubjectIdGet200Response) MarshalJSON() ([]byte, error) {
...
type NullableContentV2ObjectCharcsSubjectIdGet200Response struct {
	value *ContentV2ObjectCharcsSubjectIdGet200Response
	isSet bool
}

func (v NullableContentV2ObjectCharcsSubjectIdGet200Response) Get() *ContentV2ObjectCharcsSubjectIdGet200Response {
	return v.value
}

func (v *NullableContentV2ObjectCharcsSubjectIdGet200Response) Set(val *ContentV2ObjectCharcsSubjectIdGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableContentV2ObjectCharcsSubjectIdGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableContentV2ObjectCharcsSubjectIdGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContentV2ObjectCharcsSubjectIdGet200Response(val *ContentV2ObjectCharcsSubjectIdGet200Response) *NullableContentV2ObjectCharcsSubjectIdGet200Response {
	return &NullableContentV2ObjectCharcsSubjectIdGet200Response{value: val, isSet: true}
}

func (v NullableContentV2ObjectCharcsSubjectIdGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContentV2ObjectCharcsSubjectIdGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
