...
// checks if the ContentV2ObjectParentAllGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContentV2ObjectParentAllGet200Response{}
...
func NewContentV2ObjectParentAllGet200Response() *ContentV2ObjectParentAllGet200Response {
	this := ContentV2ObjectParentAllGet200Response{}
	return &this
}
...
func (o *ContentV2ObjectParentAllGet200Response) GetData() []ContentV2ObjectParentAllGet200ResponseDataInner {
	if o == nil || IsNil(o.Data) {
		var ret []ContentV2ObjectParentAllGet200ResponseDataInner
		return ret
	}
	return o.Data
}
...
type NullableContentV2ObjectParentAllGet200Response struct {
	value *ContentV2ObjectParentAllGet200Response
	isSet bool
}

func (v NullableContentV2ObjectParentAllGet200Response) Get() *ContentV2ObjectParentAllGet200Response {
	return v.value
}

func (v *NullableContentV2ObjectParentAllGet200Response) Set(val *ContentV2ObjectParentAllGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableContentV2ObjectParentAllGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableContentV2ObjectParentAllGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContentV2ObjectParentAllGet200Response(val *ContentV2ObjectParentAllGet200Response) *NullableContentV2ObjectParentAllGet200Response {
	return &NullableContentV2ObjectParentAllGet200Response{value: val, isSet: true}
}

func (v NullableContentV2ObjectParentAllGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContentV2ObjectParentAllGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
