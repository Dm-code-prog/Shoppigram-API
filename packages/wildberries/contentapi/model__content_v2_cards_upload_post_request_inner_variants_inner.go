...
type ContentV2CardsUploadPostRequestInnerVariantsInner struct {
	...
	Characteristics []ContentV2CardsUploadPostRequestInnerVariantsInnerCharacteristicsInner `json:"characteristics,omitempty"`
}
...
func (o *ContentV2CardsUploadPostRequestInnerVariantsInner) GetCharacteristics() []ContentV2CardsUploadPostRequestInnerVariantsInnerCharacteristicsInner {
	if o == nil || IsNil(o.Characteristics) {
		var ret []ContentV2CardsUploadPostRequestInnerVariantsInnerCharacteristicsInner
		return ret
	}
...
// SetCharacteristics gets a reference to the given []ContentV2CardsUploadPostRequestInnerVariantsInnerCharacteristicsInner and assigns it to the Characteristics field.
