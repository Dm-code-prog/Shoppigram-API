...
// checks if the ContentV2DirectoryVatGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContentV2DirectoryVatGet200Response{}
...
func NewContentV2DirectoryVatGet200Response() *ContentV2DirectoryVatGet200Response {
	this := ContentV2DirectoryVatGet200Response{}
	return &this
}
...
type NullableContentV2DirectoryVatGet200Response struct {
	value *ContentV2DirectoryVatGet200Response
	isSet bool
}

func (v NullableContentV2DirectoryVatGet200Response) Get() *ContentV2DirectoryVatGet200Response {
	return v.value
}

func (v *NullableContentV2DirectoryVatGet200Response) Set(val *ContentV2DirectoryVatGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableContentV2DirectoryVatGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableContentV2DirectoryVatGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContentV2DirectoryVatGet200Response(val *ContentV2DirectoryVatGet200Response) *NullableContentV2DirectoryVatGet200Response {
	return &NullableContentV2DirectoryVatGet200Response{value: val, isSet: true}
}

func (v NullableContentV2DirectoryVatGet200Response) MarshalJSON() ([]byte, error) {
