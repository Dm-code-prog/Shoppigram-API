...
type ApiV2QuarantineGoodsGet200Response struct {
	Data *ApiV2QuarantineGoodsGet200ResponseData `json:"data,omitempty"`
	// Флаг ошибки
...
// SetData gets a reference to the given ApiV2QuarantineGoodsGet200ResponseData and assigns it to the Data field.
